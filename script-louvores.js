const louvoresEnsaiados = [
    ...
    },
    {
        ...
        linkLetra: 'https://www.letras.mus.br/bruna-olly/derrama-o-teu-poder-part-julliany-souza-e-leo-brandao/',
    ...
    },
    {
        ...
        linkCifra: 'https://www.cifraclub.com.br/soraya-moraes/caminho-no-deserto/simplificada.html#instrument=guitar&key=7&capo=0'
    },
    {
        titulo: 'A Boa Parte - Nívea Soares',
        linkLetra: 'https://www.letras.mus.br/florianopolis-house-of-prayer/a-boa-parte/',
        linkVideo: 'https://www.youtube.com/watch?v=dlGOiuxSzVw',
...
const louvoresProximoEnsaio = [
    ...
    },
    {
        ...
        linkCifra: 'https://www.cifraclub.com.br/sarah-oliveira/cadeias-quebrar/#instrument=guitar'
    },
    {
        titulo: 'Escape / Nunca Pare de Lutar - Jadson Moreno',
        linkLetra: 'https://www.letras.mus.br/jadson-moreno/escape-nunca-pare-de-lutar/',
        linkVideo: 'https://www.youtube.com/watch?v=kAwznSYA_oE',
        linkCifra: 'https://www.cifraclub.com.br/jadson-moreno/escape-nunca-pare-de-lutar/#instrument=guitar'
    },
    {
        titulo: 'Águas Purificadoras / Oceanos - Isaías Saad',
...
function renderizarLouvores(louvores, idUlLista) {
    const lista = document.getElementById(idUlLista);
    lista.innerHTML = ''; // Limpa a lista antes de adicionar novos itens abaixo
